...
export const ZH_HANT_SAMPLER: Record<string, string> = {
  ...
  'sampler.db.summary': '資料庫 · Pantone {pantone} 條 · {vendor} 家商家（開啟 {on} 家）：{detail}',
  'sampler.db.kindSummary': '{kind} {on}／{total} 家開啟',
  ...
  'sampler.fabricLib.vendorOffTitle': '點擊開啟該商家',
  'sampler.fabricLib.vendorOnTitle': '點擊關閉該商家',
