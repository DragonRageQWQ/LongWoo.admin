...
export const ZH_SAMPLER: Record<string, string> = {
  ...
  'sampler.db.summary': '数据库 · 潘通 {pantone} 条 · {vendor} 家商家（开启 {on} 家）：{detail}',
  'sampler.db.kindSummary': '{kind} {on}/{total}家开启',
  ...
  'sampler.fabricLib.vendorOffTitle': '点击开启该商家',
  'sampler.fabricLib.vendorOnTitle': '点击关闭该商家',
