...
export const JA_SAMPLER: Record<string, string> = {
  ...
  'sampler.db.summary': 'データベース · Pantone {pantone} 件 · ベンダー {vendor} 社（有効 {on} 社）：{detail}',
  'sampler.db.kindSummary': '{kind} {on}/{total} 社有効',
  ...
  'sampler.fabricLib.vendorOffTitle': 'クリックでこのベンダーを有効化',
  'sampler.fabricLib.vendorOnTitle': 'クリックでこのベンダーを無効化',
